...
namespace BigStorage
{
    public class BigGasStorage : IBuildingConfig
    {
        ...
        {
            BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("BigGasReservoir", WIDTH, HEIGHT, "gasstorage_kanim", 100, 120f, BUILDINGS.CONSTRUCTION_MASS_KG.TIER6, MATERIALS.ALL_METALS, 800f, BuildLocationRule.OnFloor, BUILDINGS.DECOR.NONE, NOISE_POLLUTION.NOISY.TIER0, 0.2f);
